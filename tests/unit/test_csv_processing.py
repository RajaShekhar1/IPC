...
,,,,""")
    ...
    def test_it_extracts_headers(self):
        ...
        importer = self.sut.process_file_stream(csv_data_file)
...
val1,val2""")
        ...
        importer = self.sut.process_file_stream(test_lowercase_headers)
