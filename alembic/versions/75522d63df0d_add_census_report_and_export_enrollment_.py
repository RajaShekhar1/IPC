...
census_report = ReplaceableObject(
    ...
    """
    returns TABLE(
    "EMP_FIRST" character varying, 
    "EMP_LAST" character varying, 
    "EMP_SSN" character varying, 
    "EMP_GENDER" character varying, 
    "EMP_BIRTHDATE" date, 
    "EMP_EMAIL" character varying, 
    "EMP_PHONE" character varying,
    "EMP_ADDRESS1" character varying, 
    "EMP_ADDRESS2" character varying, 
    "EMP_CITY" character varying, 
    "EMP_STATE" character varying, 
    "EMP_ZIP" character varying, 
    "EMP_HEIGHT_IN" character varying, 
    "EMP_WEIGHT_LBS" character varying, 
    "EMP_SMOKER_Y_N" character varying, 
    "CLASSIFICATION" character varying, 
    "SP_FIRST" character varying,
    "SP_LAST" character varying, 
    "SP_SSN" character varying, 
    "SP_GENDER" character varying, 
    "SP_BIRTHDATE" date,
    "SP_EMAIL" character varying, 
    "SP_PHONE" character varying, 
    "SP_ADDRESS1" character varying, 
    "SP_ADDRESS2" character varying, 
    "SP_CITY" character varying, 
    "SP_STATE" character varying, 
    "SP_ZIP" character varying,
    "SP_HEIGHT_IN" character varying, 
    "SP_WEIGHT_LBS" character varying, 
    "SP_SMOKER_Y_N" character varying,
    "CH1_FIRST" character varying, 
    "CH1_LAST" character varying, 
    "CH1_BIRTHDATE" date, 
    "CH2_FIRST" character varying, 
    "CH2_LAST" character varying, 
    "CH2_BIRTHDATE" date, 
    "CH3_FIRST" character varying, 
    "CH3_LAST" character varying, 
    "CH3_BIRTHDATE" date, 
    "CH4_FIRST" character varying, 
    "CH4_LAST" character varying,
    "CH4_BIRTHDATE" date, 
    "CH5_FIRST" character varying, 
    "CH5_LAST" character varying, 
    "CH5_BIRTHDATE" date,
    "CH6_FIRST" character varying, 
    "CH6_LAST" character varying, 
    "CH6_BIRTHDATE" date)
    LANGUAGE plpgsql
    AS $$
    BEGIN
...
export_enrollment_report = ReplaceableObject(
    ...
    returns TABLE(
        ...
        "Agent Code" character varying,
        "Agent Name" character varying, 
        "Signature City" text, 
        "Signature State" character varying, 
        "Payment Mode" integer,
        "Enrollment Method" character varying, 
        "Is Employee Owner" boolean, 
        "Other Owner Name" text, 
        "Other Owner SSN" character varying, 
        "Spouse Other Owner" boolean, 
        "Spouse Other Owner SSN" character varying, 
        "Is Employee Beneficiary Spouse" boolean, 
        "Employee Beneficiary Name" text, 
        "Employee Beneficiary Relationship" text, 
        "Employee Beneficiary Birthdate" text, 
        "Employee Beneficiary SSN" character varying, 
        "Is Spouse Beneficiary Employee" boolean,
        "Spouse Beneficiary Name" text, 
        "Spouse Beneficiary Relationship" text, 
        "Spouse Beneficiary Birthdate" text,
        "Spouse Beneficiary SSN" character varying, 
        "EMP_FIRST" character varying, 
        "EMP_LAST" character varying, 
        "EMP_SSN" character varying, 
        "EMP_GENDER" character varying, 
