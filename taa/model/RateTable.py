...
FPPTI_weekly_by_premium_lookup, all_weekly_premium_options = load_age_lookup_table("taa/model/rates/FPPTI-bypremium.csv")
FPPTI_weekly_by_coverage_lookup, all_weekly_coverage_options = load_age_lookup_table("taa/model/rates/FPPTI-byface.csv")
FPPCI_weekly_by_premium_lookup, all_weekly_premium_options = load_age_lookup_table("taa/model/rates/FPPCI-bypremium.csv")
FPPCI_weekly_by_coverage_lookup, all_weekly_coverage_options = load_age_lookup_table("taa/model/rates/FPPCI-byface.csv")
