...
# Stormpath config
STORMPATH_APPLICATION = env_get_text('STORMPATH_APPLICATION', 'TAA')

# Live stormpath
STORMPATH_API_KEY_ID = env_get_text('STORMPATH_API_KEY_ID', '5NWX3320SC2BXT0Q29ZKQVB3U')
STORMPATH_API_KEY_SECRET = env_get_text('STORMPATH_API_KEY_SECRET', 'eDiUtl8S952SLnUH94WWQKsYy3lIEAeawh6/EMKWIwc')
...
BROKER_URL = env_get_text('CELERY_BROKER_URL', "amqp://") #localhost
