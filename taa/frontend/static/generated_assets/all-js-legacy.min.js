...
var dob_moment=moment.isMoment(date_of_birth)?date_of_birth:moment(date_of_birth,'MM/DD/YYYY');var today=moment({hour:0,minute:0,seconds:0,milliseconds:0});return dob_moment.isValid()&&dob_moment.isBefore(today);}
function get_date_of_birth_validation_error(date_of_birth){'use strict';if(!date_of_birth){return'Date of Birth is required.';}
