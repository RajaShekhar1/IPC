...
self.all_coverage_options[applicant_type](all_options);},should_show_step_5:function(){return true;},should_use_date_of_hire_for_identity:function(){return true;},is_fpp_product:function(){return true;},should_confirm_disclosure_notice:function(){return this.is_fpp_product();},should_confirm_payroll_deduction:function(){return this.is_fpp_product();},should_show_contingent_beneficiary:function(){return this.is_fpp_product();}};function FPPTIProduct(product_data){this.product_type="FPPTI";this.product_data=product_data;}
...
if(ui.should_show_other_insurance_questions()&&!ui.is_in_person_application()&&((!ui.insurance_product.is_fpp_product()&&general_questions_by_id['existing_insurance_remote'].get_val()!="No")||(ui.insurance_product.is_fpp_product()&&general_questions_by_id['existing_insurance_remote'].get_val()===null))){return false;}
...
if(ui.did_select_spouse_coverage()&&(ui.has_spouse_been_treated_6_months()===null||ui.has_spouse_been_disabled_6_months()===null)){return false;}}
...
if(info.step==2&&info.direction=='next'){var is_valid=true;if(ui.insurance_product.is_fpp_product()&&(ui.replacing_insurance()||ui.existing_insurance())){is_valid&=$('#questions-form').valid();}
