...
$.ajax(url,options);}
return{WizardVM:WizardVM}})();var agent_inbox=(function(){var AgentInboxViewModel=function(){var self=this;self.envelopes=ko.observableArray(fetch_envelopes());};function fetch_envelopes(){$.ajax("/agents")}
return{initialize_inbox:function(){}}})();var case_management=(function(){var loading_html="<span class='icon-spinner icon-spin grey bigger-200'></span> <span class='bigger-175'> Loading data...</span>";function refresh_census_table(case_id,url,table_selector,loading_selector,init_callback,no_data_cb,success_callback){var loading=$(loading_selector);var table=$(table_selector);var table_settings={"responsive":{breakpoints:get_responsive_datatables_breakpoints()},"autoWidth":false,"aoColumnDefs":[{"aTargets":[0],"bSortable":false,"mData":function(source){if(source.enrollment_status!==null){return'<button class="btn btn-primary btn-xs enroll-employee" data-id="'+source.id+'"><span class="ace-icon glyphicon glyphicon-plus"></span> Add Coverage</button>';}
