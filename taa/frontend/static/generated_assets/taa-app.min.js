...
return false;}
self.deserialize_occ_mapping=function(){self.occ_mapping_cache={};var data=case_data.product_settings.classification_mappings;if(!data){return;}
...
function today_between(start,end){var today=moment();return today.isSameOrAfter(moment(start),'day')&&today.isSameOrBefore(moment(end),'day')}
