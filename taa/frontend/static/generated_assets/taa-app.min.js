...
ProductEffectiveDateSettings.prototype.serialize=function(){return{product_id:this.id,effective_date_override:this.effective_date_override(),effective_date:this.effective_date_input()}};function ProductOverrideViewModel(product,case_data){var self=this;self.product=product;self.case_data=case_data;self.id=product.id;self.base_product_type=product.base_product_type;var initial_overrides=[];if(case_data.product_settings&&case_data.product_settings.state_overrides){initial_overrides=case_data.product_settings.state_overrides[product.id]||[];}
