...
function format_enrollment_status_text(status){console.log(status);if(status==="enrolled"){return"Enrolled";}else if(status==="declined"){return"Declined";}else{return"Not Enrolled";}}
