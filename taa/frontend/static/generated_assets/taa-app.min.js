...
$('#bank-draft-form').validate({errorElement:'div',errorClass:'help-block',focusInvalid:false,highlight:wizard_validate_highlight,success:wizard_validate_success,errorPlacement:bank_draft_error_placement,rules:{'bank-account-holder-name':{required:{depends:ui.requires_bank_info}},'bank-account-type':{required:{depends:ui.requires_bank_info}},'bank-account-number':{required:{depends:ui.requires_bank_info},digits:{depends:ui.requires_bank_info}},'bank-routing-number':{required:{depends:ui.requires_bank_info},digits:{depends:ui.requires_bank_info}},'bank-name':{required:{depends:ui.requires_bank_info}},'bank-street-one':{required:{depends:ui.requires_bank_info}},'bank-city-state-zip':{required:{depends:ui.requires_bank_info}}}});}
