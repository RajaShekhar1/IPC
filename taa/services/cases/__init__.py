...
SELECT
  ...
  coalesce(coverage_1.employee_premium, '')                                                             AS "Product 1 EMP Premium",
  ...
  coalesce(coverage_2.product_name, '')                                                                 AS "Product 2 Name",
  coalesce(coverage_2.total_modal_premium,
           0)                                                                             AS "Product 2 Total Modal Premium",
  coalesce(coverage_2.employee_face_value, '')                                                          AS "Product 2 EMP Coverage",
  coalesce(coverage_2.employee_premium, '')                                                             AS "Product 2 EMP Premium",
  coalesce(coverage_2.spouse_face_value, '')                                                            AS "Product 2 SP Coverage",
  coalesce(coverage_2.spouse_premium, '')                                                               AS "Product 2 SP Premium",
  coalesce(coverage_2.children_face_value, '')                                                          AS "Product 2 CH Coverage",
  coalesce(coverage_2.children_premium, '')                                                             AS "Product 2 CH Premium",
  ...
  coalesce(coverage_3.employee_face_value, '')                                                          AS "Product 3 EMP Coverage",
  coalesce(coverage_3.employee_premium, '')                                                             AS "Product 3 EMP Premium",
  coalesce(coverage_3.spouse_face_value, '')                                                            AS "Product 3 SP Coverage",
  coalesce(coverage_3.spouse_premium, '')                                                               AS "Product 3 SP Premium",
  coalesce(coverage_3.children_face_value, '')                                                          AS "Product 3 CH Coverage",
  coalesce(coverage_3.children_premium, '')                                                             AS "Product 3 CH Premium",
  ...
  coalesce(coverage_4.employee_face_value, '')                                                          AS "Product 4 EMP Coverage",
  coalesce(coverage_4.employee_premium, '')                                                             AS "Product 4 EMP Premium",
  coalesce(coverage_4.spouse_face_value, '')                                                            AS "Product 4 SP Coverage",
  coalesce(coverage_4.spouse_premium, '')                                                               AS "Product 4 SP Premium",
  coalesce(coverage_4.children_face_value, '')                                                          AS "Product 4 CH Coverage",
  coalesce(coverage_4.children_premium, '')                                                             AS "Product 4 CH Premium",
  ...
  coalesce(coverage_5.employee_face_value, '')                                                          AS "Product 5 EMP Coverage",
  coalesce(coverage_5.employee_premium, '')                                                             AS "Product 5 EMP Premium",
  coalesce(coverage_5.spouse_face_value, '')                                                            AS "Product 5 SP Coverage",
  coalesce(coverage_5.spouse_premium, '')                                                               AS "Product 5 SP Premium",
  coalesce(coverage_5.children_face_value, '')                                                          AS "Product 5 CH Coverage",
  coalesce(coverage_5.children_premium, '')                                                             AS "Product 5 CH Premium",
  ...
  coalesce(coverage_6.employee_face_value, '')                                                          AS "Product 6 EMP Coverage",
  coalesce(coverage_6.employee_premium, '')                                                             AS "Product 6 EMP Premium",
  coalesce(coverage_6.spouse_face_value, '')                                                            AS "Product 6 SP Coverage",
  coalesce(coverage_6.spouse_premium, '')                                                               AS "Product 6 SP Premium",
  coalesce(coverage_6.children_face_value, '')                                                          AS "Product 6 CH Coverage",
  coalesce(coverage_6.children_premium, '')                                                             AS "Product 6 CH Premium",
