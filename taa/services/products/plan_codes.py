...
PLAN_CODE_HI = u'HI'
PLAN_CODE_ACC = u'ACC'
PLAN_CODE_ACAOF = u'ACAOF'
PLAN_CODE_HIB01 = u'HIB01'
PLAN_CODE_HIA01 = u'HIA01'
PLAN_CODE_HIAOBG = u'HIAOBG'
PLAN_CODES_ACC_CLASS = [PLAN_CODE_ACC, PLAN_CODE_ACAOF]
PLAN_CODES_HI_CLASS = [PLAN_CODE_HI, PLAN_CODE_HIB01, PLAN_CODE_HIA01, PLAN_CODE_HIAOBG]
PLAN_CODES_SIMPLE = [PLAN_CODE_HI, PLAN_CODE_ACC, PLAN_CODE_HIB01, PLAN_CODE_HIA01, PLAN_CODE_ACAOF, PLAN_CODE_HIAOBG]
