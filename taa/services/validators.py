...
class Validator(object):
    ...
    class RequiredIfAnyInGroupValidator(object):
        ...
        def __call__(self, field, record):
            ...
            if any(group_field.get_column_from_record(record)
                ...
                return Validator().required_validator(field, record, self.message)
            return True, None, None

    def required_validator(self, field, record, message=None):
    ...
    def ssn_validator(self, field, record):
    ...
    def payment_mode_validator(self, field, record):
    ...
    def birthdate_validator(self, field, record):
    ...
    def email_validator(self, field, record):
    ...
    def coverage_validator(self, field, record):
    ...
    def premium_validator(self, field, record):
    ...
    def zip_validator(self, field, record):
    ...
    def state_validator(self, field, record):
    ...
    def validate_question_answered(self, field, record):
